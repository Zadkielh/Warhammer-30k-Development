...
SWEP.WorldModel			= "models/olaf/weapons/thunderhammer_terminator.mdl"
...
SWEP.PrintName			= "Terminator Thunder Hammer"
SWEP.Slot				= 1
SWEP.SlotPos			= 1
SWEP.DrawAmmo			= false
