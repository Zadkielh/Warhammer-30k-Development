...
SWEP.Gun = ("weapon_stormbolter") -- must be the name of your swep but NO CAPITALS!
SWEP.Category				= "Warhammer 40k Weapons" --Category where you will find your weapons
SWEP.Author				= "Olaf"
SWEP.Contact				= ""
SWEP.Purpose				= ""
SWEP.Instructions				= ""
SWEP.PrintName				= "Ryza pattern Storm Bolter"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.RPM				= 520		-- This is in Rounds Per Minute
